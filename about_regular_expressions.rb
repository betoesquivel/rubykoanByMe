...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # They always match with the longest string possible.
  ...
  # character classes are for matching single characters or same length values
  # alternatives are for different words of different length and values
