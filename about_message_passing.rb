...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # So that I can overwrite the send symbol in my class for something more useful.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # No more NoMethodError when calling a method that doesn' t exist.
    # Now I would be catching that situation.
    #
    # NOTE:
    #
